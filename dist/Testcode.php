...
<body class="font-[Poppins] bg-gray-950 h-scre">
      ...
      <nav class=" flex justify-between items-center w-[92%]  mx-auto p-1">
          ...
          <div
              ...
              <ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8 bg-gray-900 text-slate-200 transition-all ease-in duration-700">
                  <li>
                      <a class="hover:text-gray-500" href="/dist/Products1.html">Products</a>
                  </li>
                  <li>
                      <a class="hover:text-gray-500" href="#services">Service</a>
                  </li>
                  <li>
                      <a class="hover:text-gray-500" href="/dist/About.html">About</a>
                  </li>
                  <li>
                  ...
                  <div>
                      <button class="bg-gray-700 text-white px-5 py-2 mb-4 lg:mb-1 rounded-full hover:bg-gray-500" onclick="document.location='Sign In.html'">Get Started</button>
                  </div> 
              </ul>
           ...
           <div class="ml-4 sm:flex-row flex space-x-4 lg:ml-6">
            <a href="/dist/Redirect.html" class="group -m-2 flex space-x-3 items-center p-2">
  ...
  <div class="w-screen min-h-fit max-w-screen-xl mx-auto p-8">
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-7 ml-10 text-center text-white font-bold text-xl">
      ...
      <div class="relative max-w-xs h-64 overflow-hidden bg-cover bg-no-repeat bg-center" data-aos="fade-up" data-aos-delay="150">
        ...
        <button
          class="absolute top-2/3  transform -translate-x-1/2 -translate-y-1/2 px-4 py-1 text-sm md:text-base bg-amber-600 text-gray-900 rounded-full" onclick="document.location='Products1.html'">Shop
          Now</button>
      </div>
      <!-- Body Parts -->
